  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-8 relative overflow-hidden bg-gradient-to-b from-cali-black via-cali-darkPurple to-cali-black">
      ...
      <div className="text-center space-y-8 relative z-10">
        {/* Extravagant title with multiple effects */}
        <motion.div
        ...
        >
          ...
          >
            <span className="bg-gradient-to-r from-cali-magenta via-cali-purple to-cali-pink bg-clip-text text-transparent animate-shimmer">
              Cali Lights
            </span>
          </motion.h1>
        </motion.div>
        ...
        <motion.p
          ...
          className="text-2xl md:text-3xl font-medium bg-gradient-to-r from-cali-pink to-cali-purple bg-clip-text text-transparent"
        >
        ...
        >
          <p className="text-xl text-white font-light">Scan the QR code to begin</p>
          ...
          >
            <p className="text-2xl font-bold bg-gradient-to-r from-cali-magenta to-cali-pink bg-clip-text text-transparent">
